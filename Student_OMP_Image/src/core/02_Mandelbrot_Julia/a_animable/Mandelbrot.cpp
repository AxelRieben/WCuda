...
Mandelbrot::Mandelbrot(uint w, uint h, uint n, const DomaineMath& domaineMath) :
	Animable_I<uchar4>(w, h, "Mandelbrot_OMP_rgba_uchar4",domaineMath), variateurAnimation(Interval<float>(30, n), 1)
    {
    // Input
    this->n = n;
